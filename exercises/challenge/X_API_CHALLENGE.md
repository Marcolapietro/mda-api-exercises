...
public class XAPIClient {
    public static void main(String[] args) {
        ...
        // Access your credentials
        String apiKey = dotenv.get("X_API_KEY");
        String apiSecret = dotenv.get("X_API_SECRET");
        String accessToken = dotenv.get("X_ACCESS_TOKEN");
        String accessTokenSecret = dotenv.get("X_ACCESS_TOKEN_SECRET");

        // Optional: Get app mode with default value
        String appMode = dotenv.get("APP_MODE", "production");
        ...
        System.out.println("Running in " + appMode + " mode");
    }
}
```
...
class Program
{
    static void Main(string[] args)
    {
        ...
        string apiSecret = Environment.GetEnvironmentVariable("X_API_SECRET");
        string accessToken = Environment.GetEnvironmentVariable("X_ACCESS_TOKEN");
        string accessTokenSecret = Environment.GetEnvironmentVariable("X_ACCESS_TOKEN_SECRET");

        // Optional: Get app mode with default value
        string appMode = Environment.GetEnvironmentVariable("APP_MODE") ?? "production";
        ...
        Console.WriteLine($"Running in {appMode} mode");
    }
}
```
